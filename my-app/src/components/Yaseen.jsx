    ...
    return (
        <div className="soil-calculator">
            ...
            <div className="form-group">
                <label>
                    Temperature (°C):
                    <input type="number" className="input-field" value={temperature} onChange={(e) => setTemperature(e.target.value)} />
                </label>
            </div>
            <div className="form-group">
                <label>
                    Rainfall (mm):
                    <input type="number" className="input-field" value={rainfall} onChange={(e) => setRainfall(e.target.value)} />
                </label>
            </div>
            <div className="form-group">
                <label>
                    Soil Minerals (ppm):
                    <input type="number" className="input-field" value={soilMinerals} onChange={(e) => setSoilMinerals(e.target.value)} />
                </label>
            </div>
            <button onClick={handleCalculate} className="calculate-button" disabled={!isFormValid()}>Calculate</button>
            {loading ? (
